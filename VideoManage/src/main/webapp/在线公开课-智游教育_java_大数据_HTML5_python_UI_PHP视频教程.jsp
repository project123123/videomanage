...
<link rel="stylesheet" href="z/bootstrap/css/bootstrap.min.css">
...
<body class="w100" style="padding-top: 0px;">
	...
	<div class="container">
		...
		<a target="_blank" href="z/we.png" draggable="false">后台管理</a> 
			...
			<div class="course-info">
				<table cellspacing="10">
					<tbody>
						...
						<tr>
							<td><a class="opacity5"> <img src="z/bigdata.jpg" alt=""
	...
	<script src="z/bootstrap/js/npm.js"></script>
	...
	<!-- <script type="text/javascript">
	  ...
	  $(function () { $('#login').on('hide.bs.modal')
   });
	</script> -->
