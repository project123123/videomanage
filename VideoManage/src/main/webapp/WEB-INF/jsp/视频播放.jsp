...
<body class="w100" style="padding-top: 0px;">
	...
	<div class="container">
		...
		<a onclick="JavaScript:addFavorite2()"><img
			src="z/sc.png" draggable="false">加入收藏</a> <a
			target="_blank"><img src="z/we.png" draggable="false">后台管理</a>
		<a class="color_e4"><img src="z/phone.png"
				...
				<div class="container">
					<div class="v-intro">
						...
						<div class="right">
							...
							<div class="avatar">
								<span
									style="background-image: url(http://vod.zhiyou100.com/gkk/teacher/zgd.jpg)"></span>
								<p>
									<b>讲师：赵桂丹</b><br>
