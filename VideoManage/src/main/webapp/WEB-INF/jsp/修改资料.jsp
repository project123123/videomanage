                        ...
                        <div class="profile_ifo_area">
                            <form action="saveData" method="post">
                                ...
                                <div class="form_group">
                                    ...
                                    <input id="man"  type="radio" name="sex" value="man" <c:if test="${user.sex=='man'}">checked</c:if> ><label for="man">男</label>
                                    <input id="woman" type="radio" name="sex" value="woman" <c:if test="${user.sex=='woman'}">checked</c:if> ><label for="woman">女</label>
                                </div>
                                <div class="form_group">
                                ...
                                <div class="form_group">
                                    ...
                                    <input name="accounts" type="text"  readonly value="${user.accounts}" style="border:none;background:white; width: 70%">
                                </div>
                                <div class="form_group">
...
<footer>
	<div class="container">
		<ul>
			<li><img src="z/logo.png" alt="" id="foot_logo"></li>
